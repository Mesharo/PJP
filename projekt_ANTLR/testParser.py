...
class testParser ( Parser ):
    ...
    class InitContext(ParserRuleContext):
        ...
        def value(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(testParser.ValueContext)
            else:
                return self.getTypedRuleContext(testParser.ValueContext,i)


        def getRuleIndex(self):
            return testParser.RULE_init
    ...
    def init(self):
        ...
        localctx = testParser.InitContext(self, self._ctx, self.state)
    ...
    class ValueContext(ParserRuleContext):
        ...
        def init(self):
            return self.getTypedRuleContext(testParser.InitContext,0)
